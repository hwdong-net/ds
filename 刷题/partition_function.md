对于一个$S_n = \left\[ {1,2,\cdots, n} \right\] $的集合，可以又很多的partition（分割），如 $S_7 = {\left\[1,2,3,4,5,6,7 \right\]}$ 的一个分割是 ${\[1,2,5\],\[3,7\],\[4,6\] }$，即 $S_7$ 被分成了3个子集。
...
f(4) = f(6) = 3   
```
即$S_7$的元素1,2,5被映射到集合1，$S_7$的元素3,7被映射到集合2，$S_7$的元素4,6被映射到集合3。
